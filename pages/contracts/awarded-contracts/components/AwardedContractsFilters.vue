...
const emit = defineEmits<{
    "update:modelValue": [value: AwardedFilterForm];
    reset: [];
}>();
...
const updateField = <K extends keyof AwardedFilterForm>(
    key: K,
    value: AwardedFilterForm[K],
) => {
            ...
            <div class="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  min="0"
                  :class="inputClass"
                  @input="updateField('moreThanEstimatedValue', ($event.target as HTMLInputElement).value)"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  min="0"
                  :class="inputClass"
                  @input="updateField('lessThanEstimatedValue', ($event.target as HTMLInputElement).value)"
                />
              </div>
            </div>
          </div>
        ...
        <div v-if="sections.flags" class="space-y-3 p-4">
          ...
          <div>
            ...
            <input
              ...
              min="0"
              :class="inputClass"
              @input="updateField('numChanges', ($event.target as HTMLInputElement).value)"
            />
          </div>
        </div>
      </section>
